 ...
 * This file contains the register addresses for configuration and use of the IC BQ769x2
 */
...
// Direct Commands
#define ControlStatus 0x00      // When read, provides device status bits. Not recommended for customers to write to it.
#define SafetyAlertA 0x02       // Provides individual alert signals when enabled safety alerts have triggered. Bit descriptions in Safety Alert A Register.
#define SafetyStatusA 0x03      // Provides individual fault signals when enabled safety faults have triggered. Bit descriptions in Safety Status A Register.
#define SafetyAlertB 0x04       // Provides individual alert signals when enabled safety alerts have triggered. Bit descriptions in Safety Alert B Register.
#define SafetyStatusB 0x05      // Provides individual fault signals when enabled safety faults have triggered. Bit descriptions in Safety Status B Register.
#define SafetyAlertC 0x06       // Provides individual alert signals when enabled safety alerts have triggered. Bit descriptions in Safety Alert C Register.
#define SafetyStatusC 0x07      // Provides individual fault signals when enabled safety faults have triggered. Bit descriptions in Safety Status C Register.
#define PFAlertA 0x0A           // Provides individual alert signals when enabled Permanent Fail alerts have triggered. Bit descriptions in PF Alert A Register.
#define PFStatusA 0x0B          // Provides individual fault signals when enabled Permanent Fail faults have triggered. Bit descriptions in PF Status A Register.
#define PFAlertB 0x0C           // Provides individual alert signals when enabled Permanent Fail alerts have triggered. Bit descriptions in PF Alert B Register.
#define PFStatusB 0x0D          // Provides individual fault signals when enabled Permanent Fail faults have triggered. Bit descriptions in PF Status B Register.
#define PFAlertC 0x0E           // Provides individual alert signals when enabled Permanent Fail alerts have triggered. Bit descriptions in PF Alert C Register.
#define PFStatusC 0x0F          // Provides individual fault signals when enabled Permanent Fail faults have triggered. Bit descriptions in PF Status C Register.
#define PFAlertD 0x10           // Provides individual alert signals when enabled Permanent Fail alerts have triggered. Bit descriptions in PF Alert D Register.
#define PFStatusD 0x11          // Provides individual fault signals when enabled Permanent Fail faults have triggered. Bit descriptions in PF Status D Register.
#define BatteryStatus 0x12      // Flags related to battery status. Bit descriptions in Battery Status Register.
#define Cell1Voltage 0x14       // 16-bit voltage on cell 1
#define Cell2Voltage 0x16       // 16-bit voltage on cell 2
#define Cell3Voltage 0x18       // 16-bit voltage on cell 3
#define Cell4Voltage 0x1A       // 16-bit voltage on cell 4
#define Cell5Voltage 0x1C       // 16-bit voltage on cell 5
#define Cell6Voltage 0x1E       // 16-bit voltage on cell 6
#define Cell7Voltage 0x20       // 16-bit voltage on cell 7
#define Cell8Voltage 0x22       // 16-bit voltage on cell 8
#define Cell9Voltage 0x24       // 16-bit voltage on cell 9
#define Cell10Voltage 0x26      // 16-bit voltage on cell 10
#define Cell11Voltage 0x28      // 16-bit voltage on cell 11
#define Cell12Voltage 0x2A      // 16-bit voltage on cell 12
#define Cell13Voltage 0x2C      // 16-bit voltage on cell 13
#define Cell14Voltage 0x2E      // 16-bit voltage on cell 14
#define Cell15Voltage 0x30      // 16-bit voltage on cell 15
#define Cell16Voltage 0x32      // 16-bit voltage on cell 16
#define StackVoltage 0x34       // 16-bit voltage on top of stack
#define PACKPinVoltage 0x36     // 16-bit voltage on PACK pin
#define LDPinVoltage 0x38       // 16-bit voltage on LD pin
#define CC2Current 0x3A         // 16-bit CC2 current
#define AlarmStatus 0x62        // Latched signal used to assert the ALERT pin. Write a bit high to clear the latch. Bit descriptions in Alarm Status Register.
#define AlarmRawStatus 0x64     // Unlatched value of flags which can be selected to be latched (using Alarm Enable()) and used to assert the ALERT pin. Bit descriptions in Alarm Raw Status Register.
#define AlarmEnable 0x66        // Mask for Alarm Status(). Can be written to change during operation to change which alarm sources are enabled. The default value of this parameter is set by Settings:Alarm:Default Alarm Mask. Bit descriptions in Alarm Enable Register.
#define IntTemperature 0x68     // This is the most recent measured internal die temperature.
#define CFETOFFTemperature 0x6A // When the CFETOFF pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the CFETOFF pin in millivolts.
#define DFETOFFTemperature 0x6C // When the DFETOFF pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the DFETOFF pin in millivolts.
#define ALERTTemperature 0x6E   // When the ALERT pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the ALERT pin in millivolts.
#define TS1Temperature 0x70     // When the TS1 pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the TS1 pin in millivolts.
#define TS2Temperature 0x72     // When the TS2 pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the TS2 pin in millivolts.
#define TS3Temperature 0x74     // When the TS3 pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the TS3 pin in millivolts.
#define HDQTemperature 0x76     // When the HDQ pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the HDQ pin in millivolts.
#define DCHGTemperature 0x78    // When the DCHG pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the DCHG pin in millivolts.
#define DDSGTemperature 0x7A    // When the DDSG pin is configured as a thermistor input, this reports its most recent temperature measurement. When configured as ADCIN, this instead reports the measured voltage at the DDSG pin in millivolts.
#define FETStatus 0x7F          // Provides flags showing status of FETs and ALERT pin. Bit descriptions in FET Status Register.
